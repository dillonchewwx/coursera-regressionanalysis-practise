# Practise Dataset for Coursera - Regression Analysis 

## Is there an association between college major category and income?

In this assignment, we will study how income varies across different categories of college majors using data from a study of recent college graduates. In specific, we would like to investigate if there is an association between college major category and income. 
